...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'HelloWorld',
  computed: Object(vuex__WEBPACK_IMPORTED_MODULE_9__["mapGetters"])(['evenOrOdd']),
  data: function data() {
    return {
      items: [],
      fullName: ''
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_9__["mapActions"])(['increment', 'decrement', 'incrementIfOdd', 'incrementAsync'])), {}, {
    helloFunc: function helloFunc() {
      var _this = this;

      this.$api.get('api/values/get-numbers').then(function (res) {
        console.log(res);
...
var render = function() {
  ...
  return _c("div", [
    _c("h1", { on: { click: _vm.helloFunc } }, [_vm._v("Hello, world!")]),
    _vm._v(" "),
    _c(
      "ul",
    ...
    _vm._v("\n    Hello: " + _vm._s(_vm.fullName) + "\n\n    "),
    _c("div", { attrs: { id: "test-store" } }, [
      _vm._v(
        "\n        Hello State: " +
    ...
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row text-center" }, [
        ...
        _c(
          "button",
          { staticClass: "btn btn-success", on: { click: _vm.increment } },
          [_vm._v("+")]
        ),
        _vm._v(" "),
        _c(
          "button",
          { staticClass: "btn btn-danger", on: { click: _vm.decrement } },
          [_vm._v("-")]
        ),
        _vm._v(" "),
        _c(
          "button",
          { staticClass: "btn", on: { click: _vm.incrementIfOdd } },
          [_vm._v("Increment if odd")]
        ),
        _vm._v(" "),
        _c(
          "button",
          { staticClass: "btn", on: { click: _vm.incrementAsync } },
...
/* harmony import */ var _store_test_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/test/store */ "./src/store/test/store.js");
/* harmony import */ var _HelloWorld_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./HelloWorld.vue */ "./src/components/HelloWorld.vue");
...
vue__WEBPACK_IMPORTED_MODULE_2__["default"].use({
  install: function install(Vue) {
    Vue.prototype.$api = axios__WEBPACK_IMPORTED_MODULE_3___default.a.create({
...
var components = [{
  component: _HelloWorld_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
  element: 'hello-world'
}];
/* harmony default export */ __webpack_exports__["default"] = ({
  loadComponents: function loadComponents() {
    components.forEach(function (_ref) {
      ...
      new vue__WEBPACK_IMPORTED_MODULE_2__["default"]({
        store: _store_test_store__WEBPACK_IMPORTED_MODULE_4__["default"],
